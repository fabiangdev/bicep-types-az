# Microsoft.StorageCache @ 2026-08-01

## Resource Microsoft.StorageCache/amlFilesystems@2026-08-01
...
## Resource Microsoft.StorageCache/amlFilesystems/autoExportJobs@2026-08-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.StorageCache/amlFilesystems/autoImportJobs@2026-08-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-01' (ReadOnly, DeployTimeConstant): The resource api version
...
* **location**: string (Required): The geo-location where the resource lives
* **name**: string {minLength: 2, maxLength: 80, pattern: "^[0-9a-zA-Z][-0-9a-zA-Z_]{0,78}[0-9a-zA-Z]$"} (Required, DeployTimeConstant): The resource name
* **properties**: [AutoImportJobProperties](#autoimportjobproperties): Properties of the auto import job.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.StorageCache/amlFilesystems/autoImportJobs' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.StorageCache/amlFilesystems/expansionJobs@2026-08-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-01' (ReadOnly, DeployTimeConstant): The resource api version
...
* **location**: string (Required): The geo-location where the resource lives
* **name**: string {minLength: 2, maxLength: 80, pattern: "^[0-9a-zA-Z][-0-9a-zA-Z_]{0,78}[0-9a-zA-Z]$"} (Required, DeployTimeConstant): The resource name
* **properties**: [ExpansionJobProperties](#expansionjobproperties): Properties of the expansion job.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [TrackedResourceTags](#trackedresourcetags): Resource tags.
* **type**: 'Microsoft.StorageCache/amlFilesystems/expansionJobs' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.StorageCache/amlFilesystems/importJobs@2026-08-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.StorageCache/amlFilesystems/rebalanceJobs@2026-08-01
* **Readable Scope(s)**: ResourceGroup
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {minLength: 2, maxLength: 80, pattern: "^[0-9a-zA-Z][-0-9a-zA-Z_]{0,78}[0-9a-zA-Z]$"} (Required, DeployTimeConstant): The resource name
* **properties**: [RebalanceJobProperties](#rebalancejobproperties) (ReadOnly): Properties of the rebalance job.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.StorageCache/amlFilesystems/rebalanceJobs' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.StorageCache/caches@2026-08-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.StorageCache/caches/storageTargets@2026-08-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-08-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## AmlFilesystemHealth
### Properties
* **state**: 'Available' | 'Degraded' | 'Expanding' | 'Maintenance' | 'Transitioning' | 'Unavailable' | string: List of AML file system health states.
...
* **userAssignedIdentities**: [AmlFilesystemIdentityUserAssignedIdentities](#amlfilesystemidentityuserassignedidentities): A dictionary where each key is a user assigned identity resource ID, and each key's value is an empty dictionary.
...
* **clusterUuid**: string {minLength: 36, maxLength: 36, pattern: "^[0-9a-fA-F]{8}-([0-9a-fA-F]{4}-){3}[0-9a-fA-F]{12}$"} (ReadOnly): The unique identifier of the AML file system cluster.
* **currentStorageCapacityTiB**: int (ReadOnly): The current storage capacity of the AML file system, in TiB. This reflects the actual capacity including any expansions.
...
### Properties
* **adminStatus**: 'Disable' | 'Enable' | string: The administrative status of the auto import job. Possible values: 'Enable', 'Disable'. Passing in a value of 'Disable' will disable the current active auto import job. By default it is set to 'Enable'.
* **autoImportPrefixes**: string[]: An array of blob paths/prefixes that get auto imported to the cluster namespace. It has '/' as the default value. Number of maximum allowed paths is 100.
* **conflictResolutionMode**: 'Fail' | 'OverwriteAlways' | 'OverwriteIfDirty' | 'Skip' | string: How the auto import job will handle conflicts. For example, if the auto import job is trying to bring in a directory, but a file is at that path, how it handles it. Fail indicates that the auto import job should stop immediately and not do anything with the conflict. Skip indicates that it should pass over the conflict. OverwriteIfDirty causes the auto import job to delete and re-import the file or directory if it is a conflicting type, is dirty, or is currently released. OverwriteAlways extends OverwriteIfDirty to include releasing files that had been restored but were not dirty. Please reference https://learn.microsoft.com/en-us/azure/azure-managed-lustre/blob-integration#conflict-resolution-mode for a thorough explanation of these resolution modes.
* **enableDeletions**: bool: Whether or not to enable deletions during auto import. This only affects overwrite-dirty.
* **maximumErrors**: int: Total non-conflict-oriented errors (e.g., OS errors) Import will tolerate before exiting with failure. -1 means infinite. 0 means exit immediately on any error.
* **provisioningState**: 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): ARM provisioning state.
* **status**: [AutoImportJobPropertiesStatus](#autoimportjobpropertiesstatus) (ReadOnly): The status of the auto import job.

## AutoImportJobPropertiesStatus
### Properties
* **blobSyncEvents**: [AutoImportJobPropertiesStatusBlobSyncEvents](#autoimportjobpropertiesstatusblobsyncevents) (ReadOnly): The storage account blob change feed status of the auto import job.
* **importedDirectories**: int (ReadOnly): Number of directories imported during full scan.
* **importedFiles**: int (ReadOnly): Number of files imported during full scan.
* **importedSymlinks**: int (ReadOnly): Number of symlinks imported during full scan.
* **lastCompletionTimeUTC**: string (ReadOnly): The time (in UTC) of the last completed auto import job.
* **lastStartedTimeUTC**: string (ReadOnly): The time (in UTC) the latest auto import job started.
* **preexistingDirectories**: int (ReadOnly): Number of preexisting directories during full scan.
* **preexistingFiles**: int (ReadOnly): Number of preexisting files during full scan.
* **preexistingSymlinks**: int (ReadOnly): Number of preexisting symlinks during full scan.
* **rateOfBlobImport**: int (ReadOnly): Rate of blob import during full scan.
* **rateOfBlobWalk**: int (ReadOnly): Rate of blobs walked during full scan.
* **scanEndTime**: string (ReadOnly): Date and time of when the full scan ended.
* **scanStartTime**: string (ReadOnly): Date and time of when the currently running full scan began.
* **state**: 'Disabled' | 'Disabling' | 'Failed' | 'InProgress' | string (ReadOnly): The state of the auto import operation.
* **statusCode**: string (ReadOnly): Server-defined status code for auto import job.
* **statusMessage**: string (ReadOnly): Server-defined status message for auto import job.
* **totalBlobsImported**: int (ReadOnly): Total number of blobs imported during full scan.
* **totalBlobsWalked**: int (ReadOnly): Total number of blobs walked during full scan.
* **totalConflicts**: int (ReadOnly): Total conflicts encountered during full scan.
* **totalErrors**: int (ReadOnly): Total errors encountered during full scan.

## AutoImportJobPropertiesStatusBlobSyncEvents
### Properties
* **deletions**: int (ReadOnly): Number of deletions during auto import.
* **importedDirectories**: int (ReadOnly): Number of directories imported during auto import.
* **importedFiles**: int (ReadOnly): Number of files imported during auto import.
* **importedSymlinks**: int (ReadOnly): Number of symlinks imported during auto import.
* **lastChangeFeedEventConsumedTime**: string (ReadOnly): Date and time of the last Change Feed event consumed.
* **lastTimeFullySynchronized**: string (ReadOnly): Date and time when last fully synchronized.
* **preexistingDirectories**: int (ReadOnly): Number of preexisting directories during auto import.
* **preexistingFiles**: int (ReadOnly): Number of preexisting files during auto import.
* **preexistingSymlinks**: int (ReadOnly): Number of preexisting symlinks during auto import.
* **rateOfBlobImport**: int (ReadOnly): Rate of blob import per second during auto import.
* **totalBlobsImported**: int (ReadOnly): Total number of blobs imported during auto import.
* **totalConflicts**: int (ReadOnly): Total conflicts encountered during auto import.
* **totalErrors**: int (ReadOnly): Total errors encountered during auto import.
...
* **primingJobs**: [PrimingJob](#primingjob)[]: Specifies the priming jobs defined in the cache.
...
### Properties
* **newStorageCapacityTiB**: int: The new storage capacity in TiB for the AML file system after expansion. This must be a multiple of the Sku step size, and greater than the current storage capacity of the AML file system.
* **provisioningState**: 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): ARM provisioning state, see https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/Addendum.md#provisioningstate-property
* **rebalanceJobId**: string (ReadOnly): Fully qualified ARM resource ID of the child rebalance job created by this expansion. Populated after RebalanceJob is created.
* **runRebalanceJob**: bool: When true, expansion creates a RebalanceJob after completing. Optional, defaults to true.
* **status**: [ExpansionJobPropertiesStatus](#expansionjobpropertiesstatus) (ReadOnly): The status of the expansion job.

## ExpansionJobPropertiesStatus
### Properties
* **completionTimeUTC**: string (ReadOnly): The time (in UTC) when the expansion job completed. Only populated when job reaches a terminal state.
* **percentComplete**: int {minValue: 0, maxValue: 100} (ReadOnly): The percentage of expansion job completion.
* **startTimeUTC**: string (ReadOnly): The time (in UTC) the expansion job started.
* **state**: 'Completed' | 'Deleting' | 'Failed' | 'InProgress' | 'RollingBack' | string (ReadOnly): The operational state of the expansion job. InProgress indicates the expansion is still running. Completed indicates expansion finished successfully. Failed means the expansion was unable to complete due to a fatal error. Deleting indicates the expansion is being rolled back.
* **statusCode**: string (ReadOnly): Server-defined status code for expansion job.
* **statusMessage**: string (ReadOnly): Server-defined status message for expansion job.
...
### Properties
* **adminStatus**: 'Active' | 'Cancel' | string (ReadOnly): The current administrative status of the rebalance job. 'Active' indicates the job is running normally; 'Cancel' indicates cancellation has been requested.
* **expansionJobId**: string (ReadOnly): Fully qualified ARM resource ID of the parent expansion job that initiated this rebalance. Populated when the rebalance was created as part of an expansion.
* **provisioningState**: 'Canceled' | 'Creating' | 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): ARM provisioning state, see https://github.com/Azure/azure-resource-manager-rpc/blob/master/v1.0/Addendum.md#provisioningstate-property
* **status**: [RebalanceJobPropertiesStatus](#rebalancejobpropertiesstatus) (ReadOnly): The status of the rebalance job.

## RebalanceJobPropertiesStatus
### Properties
* **balancePercent**: int {minValue: 0, maxValue: 100} (ReadOnly): The balance percentage (0-100). Represents cumulative progress since the rebalance started. Reported in periodic rebalance status updates. Resets to 0 if the rebalancer node restarts.
* **bytesMoved**: int (ReadOnly): Total number of bytes moved since the rebalance started. Reported in periodic rebalance status updates. Resets to 0 if the rebalancer node restarts.
* **completionTimeUTC**: string (ReadOnly): The time (in UTC) when the rebalance job completed. Only populated when the job reaches a terminal state (Completed, Failed, or Canceled).
* **dirsMigrated**: int (ReadOnly): Total number of directories migrated since the rebalance started. Counts MDT-phase (metadata) work items, reported separately from filesMigrated (OST-phase data migrations). Reported in periodic rebalance status updates. Resets to 0 if the rebalancer node restarts.
* **estimatedRemainingSeconds**: int (ReadOnly): Estimated remaining time in seconds. Omitted during initial assessment before the rebalancer has enough data to estimate.
* **filesMigrated**: int (ReadOnly): Total number of files migrated since the rebalance started. Counts OST-phase (data) work items. Reported in periodic rebalance status updates. Resets to 0 if the rebalancer node restarts.
* **filesMovedPerSecond**: int (ReadOnly): Average files moved per second over the most recent reporting interval.
* **percentComplete**: int {minValue: 0, maxValue: 100} (ReadOnly): The percentage of rebalance job completion.
* **startTimeUTC**: string (ReadOnly): The time (in UTC) the rebalance job started.
* **state**: 'Canceled' | 'Cancelling' | 'Completed' | 'Deleting' | 'Failed' | 'InProgress' | 'RollingBack' | string (ReadOnly): The operational state of the rebalance job. InProgress indicates the rebalance is running on the cluster. Cancelling indicates a cancel has been requested. Canceled indicates the rebalance was cancelled. Completed indicates the rebalance finished successfully. Failed indicates the rebalance was unable to complete due to a fatal error. Deleting indicates the job is being cleaned up during deletion. RollingBack indicates the orchestrator is rolling back provisioned resources after a failure.
* **statusCode**: string (ReadOnly): Server-defined status code for rebalance job.
* **statusMessage**: string (ReadOnly): Server-defined status message for rebalance job.
* **throughputMiBps**: int (ReadOnly): Average throughput in mebibytes per second (1024x1024 bytes per second) over the most recent reporting interval.
* **totalErrors**: int (ReadOnly): Total cumulative non-skip errors since the rebalance started. Reported in periodic rebalance status updates. Resets to 0 if the rebalancer node restarts.
* **totalSkipped**: int (ReadOnly): Total cumulative benign skips since the rebalance started: files intentionally not migrated (for example, a lost migration lease or a stale layout), as distinct from the hard failures counted in totalErrors. Reported in periodic rebalance status updates. Resets to 0 if the rebalancer node restarts.
...
## UnknownTarget
### Properties
* **attributes**: [UnknownTargetAttributes](#unknowntargetattributes): Dictionary of string->string pairs containing information about the Storage Target.

## UnknownTargetAttributes
### Properties
### Additional Properties
* **Additional Properties Type**: string
