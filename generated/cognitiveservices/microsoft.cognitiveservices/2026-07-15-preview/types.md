...
## Resource Microsoft.CognitiveServices/accounts@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/arcDeployments@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **etag**: string (ReadOnly): Resource Etag.
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string {pattern: "^[a-z0-9]([-a-z0-9]{0,61}[a-z0-9])?$"} (Required, DeployTimeConstant): The resource name
* **properties**: [ArcDeploymentProperties](#arcdeploymentproperties) (Required): Properties of the Cognitive Services Arc deployment.
* **sku**: [ArcDeploymentSku](#arcdeploymentsku) (Required): The Arc deployment SKU. Only the SKU name is required for Arc deployments.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.CognitiveServices/accounts/arcDeployments' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.CognitiveServices/accounts/capabilityHosts@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/commitmentPlans@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/computes@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
* **name**: string {minLength: 1, maxLength: 63, pattern: "^[a-zA-Z0-9]([a-zA-Z0-9_-]*[a-zA-Z0-9])?$"} (Required, DeployTimeConstant): The resource name
* **properties**: [ComputeProperties](#computeproperties) (Required): Polymorphic properties of the compute resource. Use computeType to select Cluster or ContainerInstance.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [ComputeTags](#computetags): Resource tags.
* **type**: 'Microsoft.CognitiveServices/accounts/computes' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.CognitiveServices/accounts/connections@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/defenderForAISettings@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/deployments@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/encryptionScopes@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/managedComputeDeployments@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
* **properties**: [ManagedComputeDeploymentProperties](#managedcomputedeploymentproperties): Properties of the Cognitive Services managed compute deployment.
* **sku**: [Sku](#sku): The resource model definition representing SKU
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.CognitiveServices/accounts/managedComputeDeployments' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.CognitiveServices/accounts/managedNetworks@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/managedNetworks/outboundRules@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/networkSecurityPerimeterConfigurations@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
...
## Resource Microsoft.CognitiveServices/accounts/privateEndpointConnections@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/projects@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/projects/applications@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/projects/applications/agentDeployments@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [AgentDeploymentProperties](#agentdeploymentproperties) (Required): [Required] Additional attributes of the entity.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.CognitiveServices/accounts/projects/applications/agentDeployments' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.CognitiveServices/accounts/projects/capabilityHosts@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/projects/connections@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/projects/workbenches@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **identity**: [Identity](#identity): Identity for the resource.
* **location**: string: The location of the workbench resource.
* **name**: string {minLength: 1, maxLength: 63, pattern: "^[a-zA-Z0-9]([a-zA-Z0-9_-]*[a-zA-Z0-9])?$"} (Required, DeployTimeConstant): The resource name
* **properties**: [WorkbenchProperties](#workbenchproperties) (Required): Properties of the workbench resource.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **tags**: [WorkbenchTags](#workbenchtags): Resource tags.
* **type**: 'Microsoft.CognitiveServices/accounts/projects/workbenches' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.CognitiveServices/accounts/raiBlocklists@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/raiBlocklists/raiBlocklistItems@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/raiPolicies@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/raiToolLabels@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/raitopics@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/accounts/testRaiExternalSafetyProvider@2026-07-15-preview
...
## Resource Microsoft.CognitiveServices/commitmentPlans@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/commitmentPlans/accountAssociations@2026-07-15-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/locations/computeOperations@2026-07-15-preview
...
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [ComputeOperationStatusProperties](#computeoperationstatusproperties) (ReadOnly): The properties of the compute operation status.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.CognitiveServices/locations/computeOperations' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.CognitiveServices/locations/raiContentFilters@2026-07-15-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/locations/resourceGroups/deletedAccounts@2026-07-15-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/quotaTiers@2026-07-15-preview
* **Readable Scope(s)**: Subscription
...
## Resource Microsoft.CognitiveServices/raiExternalSafetyProviders@2026-07-15-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.CognitiveServices/raiPolicy@2026-07-15-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: Subscription
### Properties
* **apiVersion**: '2026-07-15-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function addRaiBlocklistItems (Microsoft.CognitiveServices/accounts/raiBlocklists@2026-07-15-preview)
...
## Function batchOutboundRules (Microsoft.CognitiveServices/accounts/managedNetworks@2026-07-15-preview)
...
## Function checkSkuAvailability (Microsoft.CognitiveServices/locations@2026-07-15-preview)
...
## Function evaluateDeploymentPolicies (Microsoft.CognitiveServices/accounts@2026-07-15-preview)
* **Resource**: Microsoft.CognitiveServices/accounts
* **ApiVersion**: 2026-07-15-preview
* **Input**: [EvaluateDeploymentPoliciesRequest](#evaluatedeploymentpoliciesrequest)
* **Output**: [EvaluateDeploymentPoliciesResponse](#evaluatedeploymentpoliciesresponse)

## Function listAgents (Microsoft.CognitiveServices/accounts/projects/applications@2026-07-15-preview)
...
## Function listKeys (Microsoft.CognitiveServices/accounts@2026-07-15-preview)
* **Resource**: Microsoft.CognitiveServices/accounts
* **ApiVersion**: 2026-07-15-preview
* **Output**: [ApiKeys](#apikeys)

## Function pause (Microsoft.CognitiveServices/accounts/deployments@2026-07-15-preview)
* **Resource**: Microsoft.CognitiveServices/accounts/deployments
* **ApiVersion**: 2026-07-15-preview
* **Output**: [Deployment](#deployment)

## Function provision (Microsoft.CognitiveServices/accounts/managedNetworks@2026-07-15-preview)
* **Resource**: Microsoft.CognitiveServices/accounts/managedNetworks
* **ApiVersion**: 2026-07-15-preview
* **Input**: any
* **Output**: [ManagedNetworkProvisionStatus](#managednetworkprovisionstatus)

## Function reconcile (Microsoft.CognitiveServices/accounts/networkSecurityPerimeterConfigurations@2026-07-15-preview)
...
## Function regenerateKey (Microsoft.CognitiveServices/accounts@2026-07-15-preview)
* **Resource**: Microsoft.CognitiveServices/accounts
* **ApiVersion**: 2026-07-15-preview
* **Input**: [RegenerateKeyParameters](#regeneratekeyparameters)
* **Output**: [ApiKeys](#apikeys)

## Function resume (Microsoft.CognitiveServices/accounts/deployments@2026-07-15-preview)
* **Resource**: Microsoft.CognitiveServices/accounts/deployments
* **ApiVersion**: 2026-07-15-preview
* **Output**: [Deployment](#deployment)
...
## AccountProperties
### Properties
* **a365LoggingEnabled**: bool: Specifies whether A365 logging is enabled. Defaults to true. Set to false to opt out.
* **abusePenalty**: [AbusePenalty](#abusepenalty) (ReadOnly): The abuse penalty.
* **agentHostingConfigurations**: [AgentHostingConfiguration](#agenthostingconfiguration)[] {minLength: 1, maxLength: 1}: Customer-owned AKS hosting configurations for Foundry agents. This property can only be specified when the account is created; an existing account without a hosting configuration cannot add one later. This API version supports exactly one configuration, while the array shape is reserved for future API versions that may support multiple configurations. Once set, the configuration cannot be changed, removed, or reordered. Account update requests should omit this property or send the complete existing value unchanged. Responses only include hosting configuration types defined by the requested API version.
...
* **capabilitySettings**: [CapabilitySettings](#capabilitysettings): Reusable default agent capability settings inherited by child projects.
...
* **foundryAutoUpgrade**: [FoundryAutoUpgrade](#foundryautoupgrade): Represents the foundry auto-upgrade configuration for a Cognitive Services account.
...
* **provisioningState**: 'Accepted' | 'Canceled' | 'Creating' | 'Deleting' | 'ExtensionUnreachable' | 'Failed' | 'Moving' | 'ResolvingDNS' | 'Succeeded' | string (ReadOnly): Gets the status of the cognitive services account at the time the operation was called.
...
### Base Properties
* **name**: string {minLength: 1, maxLength: 64} (Required): Unique name of the hosting configuration within the Foundry account.

### ManagedClusterAgentHostingConfiguration
#### Properties
* **clusterResourceId**: string (Required): Azure resource ID of the customer-owned AKS managed cluster that runs the hosted agent workloads.
* **hostingManagementIdentityResourceId**: string (Required): Azure resource ID of the user-assigned managed identity used by the Foundry resource provider to manage the hosting configuration. The identity must be assigned to the Foundry account in identity.userAssignedIdentities.
* **hostingType**: 'ManagedCluster' (Required): Type of infrastructure used to host Foundry agents.
* **storageAccountResourceId**: string (Required): Azure resource ID of the customer-owned storage account used by the hosted agents. The storage account must be in the same subscription and region as the AKS cluster, and its data-plane endpoint must be reachable from the workload network.
* **workloadIdentityResourceId**: string (Required): Azure resource ID of the separate user-assigned managed identity federated to service accounts on the AKS cluster. Hosted agents use this identity to access the Azure Storage blob data plane.
...
* **agents**: [AgentReferenceProperties](#agentreferenceproperties)[]: The list of agent definitions comprising this application, returned as references to the objects under the parent project; use this to obtain a flat list of all agent-version pairs represented by this application.
...
* **properties**: [AgentReferenceProperties](#agentreferenceproperties) (Required): [Required] Additional attributes of the entity.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
...
* **value**: [AgentReference](#agentreference)[]: An array of objects of type Agent Reference.
...
#### Properties
* **type**: 'Channels' (Required): Authorization scheme type.
...
### Properties
* **cpu**: string (Required): Kubernetes CPU quantity string, for example 500m, 2, 4, or 8.
* **memory**: string (Required): Kubernetes memory quantity string, for example 512Mi, 2Gi, or 16Gi.

## ArcDeploymentKubernetesResources
### Properties
* **limits**: [ArcDeploymentResourceRequirements](#arcdeploymentresourcerequirements): Kubernetes resource limits for each deployment replica.
* **requests**: [ArcDeploymentCpuMemoryResourceRequirements](#arcdeploymentcpumemoryresourcerequirements): Kubernetes CPU and memory resource requests for each deployment replica.

## ArcDeploymentModel
### Properties
* **format**: string (Required): Deployment model format.
* **name**: string (Required): Deployment model name.

## ArcDeploymentProperties
### Properties
* **capabilities**: [ArcDeploymentPropertiesCapabilities](#arcdeploymentpropertiescapabilities) (ReadOnly): Read-only. Deployment capabilities represented as key-value pairs.
* **compute**: 'cpu' | 'gpu' | string (Required): Compute type for the deployment. Required on creation and immutable after creation.
* **deploymentState**: 'Paused' | 'Running' | string: The deployment state.
* **deploymentTemplate**: string: Optional deployment template identifier for advanced vLLM tuning. Allowed only when runtime is vllm.
Example: azureml://registries/{registry}/deploymenttemplates/{template}/versions/{version}
* **extensionId**: string (Required): Full Azure resource ID of the Foundry inference extension on the target Arc-enabled Kubernetes cluster. Required on creation and immutable after creation.
* **inferenceEndpoint**: string (ReadOnly): Read-only. Base URL for inference calls to this deployment on the Arc cluster. Populated when provisioningState is Succeeded.
* **model**: [ArcDeploymentModel](#arcdeploymentmodel) (Required): Model reference. Required on creation and immutable after creation.
* **nodeSelector**: [ArcDeploymentPropertiesNodeSelector](#arcdeploymentpropertiesnodeselector): Kubernetes node selector key-value map used to schedule pods onto nodes with matching labels.
* **provisioningDetails**: [ArcDeploymentProvisioningDetails](#arcdeploymentprovisioningdetails) (ReadOnly): Read-only. Status message and timestamp from the last provisioning operation.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Creating' | 'Deleting' | 'ExtensionUnreachable' | 'Failed' | 'Moving' | 'ResolvingDNS' | 'Succeeded' | string (ReadOnly): Read-only. Current provisioning state.
* **raiPolicyName**: string: The name of RAI policy.
* **replicas**: int {minValue: 1, maxValue: 100} (Required): Physical replica count on the Arc cluster.
* **resources**: [ArcDeploymentKubernetesResources](#arcdeploymentkubernetesresources) (Required): Per-replica Kubernetes resource requests and limits.
* **runtime**: 'onnx-genai' | 'vllm' | string (Required): Inference runtime. Required on creation and immutable after creation.
* **vllmParameters**: [ArcDeploymentVllmParameters](#arcdeploymentvllmparameters) (ReadOnly): Read-only. Effective vLLM runtime parameters resolved for the deployed model. Returned only when runtime is vllm.

## ArcDeploymentPropertiesCapabilities
### Properties
### Additional Properties
* **Additional Properties Type**: string
...
### Properties
* **lastOperationTimestamp**: string: Timestamp of the last provisioning operation.
* **message**: string: A human-readable status message from the last provisioning operation.

## ArcDeploymentResourceRequirements
### Properties
* **cpu**: string: Kubernetes CPU quantity string, for example 500m, 2, 4, or 8.
Required with memory when specifying CPU and memory limits. Do not specify with gpu.
* **gpu**: int {minValue: 1}: Kubernetes GPU quantity, for example 1, 2, or 5.
Required when specifying GPU limits. Do not specify with cpu or memory.
* **memory**: string: Kubernetes memory quantity string, for example 512Mi, 2Gi, or 16Gi.
Required with cpu when specifying CPU and memory limits. Do not specify with gpu.

## ArcDeploymentSku
### Properties
* **name**: 'Arc' | string (Required): The name of the Arc deployment SKU. Must be Arc.

## ArcDeploymentVllmParameters
### Properties
* **enforceEager**: bool: Whether eager execution is enforced for the vLLM runtime.
* **gpuMemoryUtilization**: int: Fraction of GPU memory reserved for model execution.
* **maxModelLen**: int: Maximum model context length.
* **tensorParallelSize**: int: Number of GPUs used for tensor parallelism.
...
* **description**: string: The asset description text.
* **enablePublicHostingEnvironment**: bool: Whether public hosting environment is enabled for the capability host
...
## CapabilitySettings
### Properties
* **blobStore**: string: Azure resource ID of the blob store used by agent file and artifact storage.
* **documentStore**: string: Azure resource ID of the document store used by agent runtime state.
* **vectorStore**: string: Azure resource ID of the vector store used by agent retrieval and indexing.
...
* **error**: [ErrorDetail](#errordetail): Error details if the operation failed.
* **startTime**: string (ReadOnly): The start time of the operation.
* **status**: 'Canceled' | 'Failed' | 'InProgress' | 'Succeeded' | string (ReadOnly): The status of the operation.

## ComputeProperties
* **Discriminator**: computeType

### Base Properties
* **creationTime**: string (ReadOnly): Creation time of the compute resource.
* **errors**: [ErrorDetail](#errordetail)[] (ReadOnly): Error details for the compute resource.
* **location**: string (Required): The location of the compute resource.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Disabled' | 'Failed' | 'Restarting' | 'Scaling' | 'Starting' | 'Stopped' | 'Stopping' | 'Succeeded' | string (ReadOnly): Provisioning state of the compute resource.

### ClusterComputeProperties
#### Properties
* **computeType**: 'Cluster' (Required): The type of compute resource.
* **pools**: [Pool](#pool)[] (Required): Pools attached to this compute cluster.
* **subnetArmId**: string: ARM ID of the subnet used for compute.

### ContainerInstanceComputeProperties
#### Properties
* **computeType**: 'ContainerInstance' (Required): The type of compute resource.
* **connectivityEndpoints**: [ConnectivityEndpoints](#connectivityendpoints) (ReadOnly): Network connectivity endpoints assigned to the container instance.
* **idleTimeBeforeShutdown**: string: ISO 8601 duration before the idle instance is automatically shut down (e.g., 'PT30M').
* **imageLink**: string (Required): Container image URI (e.g., MCR or ACR image path) for the container instance.
* **sshSettings**: [SshSettings](#sshsettings): SSH configuration for remote access to the container instance.
* **targetClusterId**: string (Required): ARM resource ID of the parent cluster that hosts this container instance.
...
### Properties
* **publicIpAddress**: string (ReadOnly): The public IP address of the compute instance.
* **sshPort**: int (ReadOnly): The SSH port for the compute instance.
...
### Properties
* **errorMessage**: string: Error message if the evaluation outcome is Error.
* **evaluationOutcome**: 'Compliant' | 'Error' | 'NonCompliant' | string: The evaluation outcome.
* **nonCompliantAssignments**: [PolicyAssignmentEvaluationDetails](#policyassignmentevaluationdetails)[]: Details of non-compliant policy assignments.
...
* **contextCacheContainerId**: string: The resource ID of the context cache container associated with this deployment.
...
* **speculativeDecoding**: [DeploymentSpeculativeDecoding](#deploymentspeculativedecoding): Speculative decoding settings for the deployment. This configuration applies to Fireworks model formats.
...
### Properties
* **draftModel**: [DeploymentModel](#deploymentmodel) (Required): Draft model used to generate speculative decoding tokens.
* **draftTokenCount**: int {minValue: 1}: The number of draft tokens attempted per speculation step.
...
* **properties**: [EvaluateDeploymentPoliciesDeploymentProperties](#evaluatedeploymentpoliciesdeploymentproperties) (Required): Properties of the hypothetical deployment.

## EvaluateDeploymentPoliciesDeploymentProperties
### Properties
* **model**: [DeploymentModel](#deploymentmodel) (Required): The model to evaluate.
* **raiPolicyName**: string: The name of the RAI policy to evaluate.

## EvaluateDeploymentPoliciesRequest
### Properties
* **deployments**: [EvaluateDeploymentPoliciesDeployment](#evaluatedeploymentpoliciesdeployment)[] (Required): The list of hypothetical deployments to evaluate against Azure Policy.

## EvaluateDeploymentPoliciesResponse
### Properties
* **results**: [EvaluateDeploymentPoliciesResponseResults](#evaluatedeploymentpoliciesresponseresults): Per-deployment policy evaluation results, keyed by deployment name.

## EvaluateDeploymentPoliciesResponseResults
### Properties
### Additional Properties
* **Additional Properties Type**: [DeploymentPolicyEvaluationResult](#deploymentpolicyevaluationresult)

## FoundryAutoUpgrade
### Properties
* **mode**: 'Disabled' | 'Enabled' | string: Gets or sets the auto-upgrade mode.
* **plannedByMicrosoft**: bool: Gets or sets a value indicating whether the auto-upgrade is planned by Microsoft.
* **scheduledAt**: string: Gets or sets the scheduled time for the auto-upgrade.
* **statusReason**: string: Gets or sets the status reason for the auto-upgrade configuration.
...
### Properties
* **acceleratorsPerInstance**: int (ReadOnly): Read-only. Number of accelerators (GPUs) consumed by each model instance, sourced from the deployment template.
* **acceleratorType**: string: Accelerator type (e.g., H100_80GB). Optional on creation; immutable after creation.
* **capabilities**: [ManagedComputeDeploymentPropertiesCapabilities](#managedcomputedeploymentpropertiescapabilities) (ReadOnly): Deployment capabilities represented as key-value pairs.
Example: { assetsV2: "true" }.
* **computeId**: string: Foundry compute ARM resource ID for VM-backed managed compute deployments. Required when sku.name is VmManagedCompute; immutable after creation.
* **deploymentTemplate**: string: Deployment template identifier. Optional on creation.
...
* **model**: string (Required): AzureML Registry model asset URI. Required on creation; immutable after creation.
Example: azureml://registries/{registry}/models/{model}/versions/{version}
* **priority**: string: Scheduling priority for VM-backed managed compute deployments. Immutable after creation.
* **provisioningDetails**: [ManagedComputeDeploymentProvisioningDetails](#managedcomputedeploymentprovisioningdetails) (ReadOnly): Read-only. Status message and timestamp from the last provisioning operation.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Creating' | 'Deleting' | 'ExtensionUnreachable' | 'Failed' | 'Moving' | 'ResolvingDNS' | 'Succeeded' | string (ReadOnly): Read-only. Current provisioning state.
* **routes**: [ManagedComputeDeploymentRoutes](#managedcomputedeploymentroutes) (ReadOnly): Read-only. Inference route paths relative to the account endpoint. Populated when provisioningState is Succeeded.
* **totalAccelerators**: int (ReadOnly): Read-only. Total accelerators allocated: sku.capacity (instances) x acceleratorsPerInstance.
* **versionUpgradeOption**: 'NoAutoUpgrade' | 'OnceCurrentVersionExpired' | 'OnceNewDefaultVersionAvailable' | string: Template auto-upgrade policy. Defaults to OnceNewDefaultVersionAvailable.

## ManagedComputeDeploymentPropertiesCapabilities
### Properties
### Additional Properties
* **Additional Properties Type**: string
...
### Properties
* **chatCompletionsScoringPath**: string: Relative path to the chat completions scoring endpoint.
* **messagesApiScoringPath**: string: Relative path to the messages API scoring endpoint.
* **swagger**: string: Relative path to the Swagger/OpenAPI endpoint.
...
### Properties
* **assignmentId**: string: The policy assignment ID.
* **effect**: string: The policy effect (e.g., Deny, Audit).
* **evaluationOutcome**: 'Compliant' | 'Error' | 'NonCompliant' | string: The evaluation outcome for this assignment.
* **expressionEvaluations**: [PolicyExpressionEvaluationDetails](#policyexpressionevaluationdetails)[]: Expression-level evaluation details.
* **nonComplianceReason**: string: The reason for non-compliance.
...
### Properties
* **expression**: string: The policy expression.
* **expressionKind**: string: The kind of expression.
* **expressionValue**: string: The actual value of the expression.
* **operator**: string: The operator used in evaluation.
* **result**: string: The evaluation result.
* **targetValue**: string: The target value of the expression.

## Pool
### Properties
* **instanceType**: string (Required): The instance type (VM SKU) used in the pool.
* **name**: string (Required): The name of the pool.
* **nodeCount**: int (Required): The number of nodes in the pool.
* **vmPriority**: 'Regular' | 'Spot' | string: The VM priority of the pool.
...
## ProjectProperties
### Properties
* **capabilitySettings**: [CapabilitySettings](#capabilitysettings): Effective agent capability settings for the project. Optional partial override of the account defaults; omitted fields inherit from the parent account when present. Settable only at create time.
...
* **provisioningState**: 'Accepted' | 'Canceled' | 'Creating' | 'Deleting' | 'ExtensionUnreachable' | 'Failed' | 'Moving' | 'ResolvingDNS' | 'Succeeded' | string (ReadOnly): Gets the status of the cognitive services project at the time the operation was called.
...
### Properties
* **name**: string (Required): The HTTP header name (e.g., "Authorization", "X-Custom-Auth").
* **operation**: 'Insert' | 'Remove' | 'Set' | string (Required): The operation to perform on this header.
* **value**: string {sensitive} (WriteOnly): A static header value. Write-only: accepted on create/update, never returned on read.
...
* **valueRef**: [RaiEgressHeaderValueRef](#raiegressheadervalueref): A dynamic header value resolved at request time from a secret or managed identity.

## RaiEgressHeaderValueRef
### Properties
* **managedIdentityRef**: [RaiEgressManagedIdentityRef](#raiegressmanagedidentityref): Resolve the value from a managed-identity token.
* **secretRef**: [RaiEgressSecretRef](#raiegresssecretref): Resolve the value from a stored secret.

## RaiEgressManagedIdentityRef
### Properties
* **format**: string: Optional format for the resolved token; "{value}" is the placeholder, e.g. "Bearer {value}".
* **resource**: string (Required): The resource/audience the token is requested for.

## RaiEgressPolicyConfig
### Properties
* **defaultAction**: 'Allow' | 'Deny' | string: The default action when no user-defined rules match.
...
* **description**: string: Description of the egress policy.
* **mode**: 'Audit' | 'Enforced' | string: The enforcement mode for egress rules.
...
* **rules**: [RaiEgressRule](#raiegressrule)[]: Ordered list of egress rules. First matching rule wins.
...
### Properties
* **host**: string: Target host. Original host is kept if omitted.
* **path**: string: Target path (literal string). Original path (and query) is kept if omitted.
* **scheme**: 'http' | 'https' | string: Target scheme. Original scheme is kept if omitted.

## RaiEgressRule
### Properties
* **action**: [RaiEgressRuleAction](#raiegressruleaction) (Required): The action to take when this rule matches, including the action type and any
type-specific configuration (headers for Transform, rewrite target for Rewrite).
* **description**: string: Description of the rule.
* **match**: [RaiEgressRuleMatch](#raiegressrulematch): The match criteria for this rule.
* **name**: string (Required): Name of the rule. Must be unique within the policy.
* **ruleType**: 'Fqdn' | string (Required): The type of rule (e.g., Fqdn). Determines how match criteria are interpreted.

## RaiEgressRuleAction
### Properties
* **actionType**: 'Allow' | 'Deny' | 'Rewrite' | 'Transform' | string (Required): The kind of action.
* **headers**: [RaiEgressHeaderTransform](#raiegressheadertransform)[]: Header transforms to apply. Required for Transform; optional for Rewrite;
not allowed for Allow or Deny.
* **rewrite**: [RaiEgressRewriteTarget](#raiegressrewritetarget): Destination override. Required for Rewrite; not allowed otherwise.
...
## RaiEgressSecretRef
### Properties
* **format**: string: Optional format for the resolved value; "{value}" is the placeholder, e.g. "Bearer {value}".
* **secretId**: string (Required): Identifier of the secret to inject.
* **secretKey**: string {sensitive}: Optional key within the secret.
...
* **egressPolicy**: [RaiEgressPolicyConfig](#raiegresspolicyconfig): Egress (outbound network) policy controlling which external endpoints sandboxed
...
## SshSettings
### Properties
* **adminEnabled**: bool: Whether SSH admin access is enabled.
* **sshPublicKey**: string: The SSH public key for authenticating to the compute instance.
...
## WorkbenchProperties
### Properties
* **connectivityEndpoints**: [ConnectivityEndpoints](#connectivityendpoints) (ReadOnly): Network connectivity endpoints assigned to the workbench.
* **creationTime**: string (ReadOnly): Creation time of the workbench resource.
* **datasetId**: string: The dataset ID to mount for the workbench.
* **errors**: [ErrorDetail](#errordetail)[] (ReadOnly): Error details for the workbench resource.
* **idleTimeBeforeShutdown**: string: ISO 8601 duration before the idle workbench is automatically shut down (e.g., 'PT30M').
* **imageLink**: string (Required): Container image URI (e.g., MCR or ACR image path) for the workbench.
* **provisioningState**: 'Accepted' | 'Canceled' | 'Deleting' | 'Disabled' | 'Failed' | 'Restarting' | 'Scaling' | 'Starting' | 'Stopped' | 'Stopping' | 'Succeeded' | string (ReadOnly): Provisioning state of the workbench resource.
* **sshSettings**: [SshSettings](#sshsettings): SSH configuration for remote access to the workbench.
* **targetClusterId**: string (Required): ARM resource ID of the parent cluster that hosts this workbench.
* **webEndpoint**: string (ReadOnly): The web endpoint URL for accessing the workbench.
