# Microsoft.Cdn @ 2026-07-01

## Resource Microsoft.Cdn/cdnWebApplicationFirewallPolicies@2026-07-01
...
## Resource Microsoft.Cdn/profiles@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/afdEndpoints@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/afdEndpoints/routes@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/customDomains@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/endpoints@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/endpoints/customDomains@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/endpoints/originGroups@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/endpoints/origins@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/originGroups@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/originGroups/origins@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/ruleSets@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
* **id**: string (ReadOnly, DeployTimeConstant): The resource id
* **name**: string (Required, DeployTimeConstant): The resource name
* **properties**: [RuleSetProperties](#rulesetproperties): The JSON object that contains the properties of the Rule Set to create.
* **systemData**: [SystemData](#systemdata) (ReadOnly): Azure Resource Manager metadata containing createdBy and modifiedBy information.
* **type**: 'Microsoft.Cdn/profiles/ruleSets' (ReadOnly, DeployTimeConstant): The resource type

## Resource Microsoft.Cdn/profiles/ruleSets/rules@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/secrets@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.Cdn/profiles/securityPolicies@2026-07-01
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-07-01' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function cdnCanMigrateToAfd (Microsoft.Cdn/profiles@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2026-07-01
* **Output**: [CanMigrateResult](#canmigrateresult)

## Function cdnMigrateToAfd (Microsoft.Cdn/profiles@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2026-07-01
* **Input**: [CdnMigrationToAfdParameters](#cdnmigrationtoafdparameters)
* **Output**: [MigrateResult](#migrateresult)

## Function checkEndpointNameAvailability (Microsoft.Cdn/profiles@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2026-07-01
...
## Function checkHostNameAvailability (Microsoft.Cdn/profiles@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2026-07-01
...
## Function checkResourceUsage (Microsoft.Cdn/profiles@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2026-07-01
* **Output**: [ResourceUsageListResult](#resourceusagelistresult)

## Function checkResourceUsage (Microsoft.Cdn/profiles/endpoints@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles/endpoints
* **ApiVersion**: 2026-07-01
* **Output**: [ResourceUsageListResult](#resourceusagelistresult)

## Function disableCustomHttps (Microsoft.Cdn/profiles/endpoints/customDomains@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles/endpoints/customDomains
* **ApiVersion**: 2026-07-01
* **Output**: [CustomDomain](#customdomain)

## Function enableCustomHttps (Microsoft.Cdn/profiles/endpoints/customDomains@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles/endpoints/customDomains
* **ApiVersion**: 2026-07-01
* **Input**: [CustomDomainHttpsParameters](#customdomainhttpsparameters)
* **Output**: [CustomDomain](#customdomain)

## Function generateSsoUri (Microsoft.Cdn/profiles@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2026-07-01
* **Output**: [SsoUri](#ssouri)

## Function getSupportedOptimizationTypes (Microsoft.Cdn/profiles@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2026-07-01
* **Output**: [SupportedOptimizationTypesListResult](#supportedoptimizationtypeslistresult)

## Function start (Microsoft.Cdn/profiles/endpoints@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles/endpoints
* **ApiVersion**: 2026-07-01
* **Output**: [Endpoint](#endpoint)

## Function stop (Microsoft.Cdn/profiles/endpoints@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles/endpoints
* **ApiVersion**: 2026-07-01
* **Output**: [Endpoint](#endpoint)

## Function upgrade (Microsoft.Cdn/profiles@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2026-07-01
* **Input**: [ProfileUpgradeParameters](#profileupgradeparameters)
* **Output**: [Profile](#profile)

## Function usages (Microsoft.Cdn/profiles@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2026-07-01
* **Output**: [UsagesListResult](#usageslistresult)

## Function usages (Microsoft.Cdn/profiles/afdEndpoints@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles/afdEndpoints
* **ApiVersion**: 2026-07-01
* **Output**: [UsagesListResult](#usageslistresult)

## Function usages (Microsoft.Cdn/profiles/originGroups@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles/originGroups
* **ApiVersion**: 2026-07-01
* **Output**: [UsagesListResult](#usageslistresult)

## Function usages (Microsoft.Cdn/profiles/ruleSets@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles/ruleSets
* **ApiVersion**: 2026-07-01
* **Output**: [UsagesListResult](#usageslistresult)

## Function validateCustomDomain (Microsoft.Cdn/profiles/afdEndpoints@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles/afdEndpoints
* **ApiVersion**: 2026-07-01
* **Input**: [ValidateCustomDomainInput](#validatecustomdomaininput)
* **Output**: [ValidateCustomDomainOutput](#validatecustomdomainoutput)

## Function validateCustomDomain (Microsoft.Cdn/profiles/endpoints@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles/endpoints
* **ApiVersion**: 2026-07-01
* **Input**: [ValidateCustomDomainInput](#validatecustomdomaininput)
* **Output**: [ValidateCustomDomainOutput](#validatecustomdomainoutput)

## Function validateSecret (Microsoft.Cdn/profiles@2026-07-01)
* **Resource**: Microsoft.Cdn/profiles
* **ApiVersion**: 2026-07-01
...
* **serverTlsGroupPolicy**: 'Custom' | 'Enhanced' | 'Standard' | string: Server TLS group policy that will be used for Https.
* **serverTlsGroups**: ('SecP256r1MLKEM768' | 'SecP384r1MLKEM1024' | 'X25519' | 'X25519MLKEM768' | 'prime256v1' | 'secp384r1' | 'secp521r1' | string)[]: Server TLS groups that will be used for Https when serverTlsGroupPolicy is Custom.
...
* **mtlsSettings**: [AFDDomainMtlsParameters](#afddomainmtlsparameters): The configuration specifying how to enable mutual TLS for the domain, including specifying allowed FQDNs and which server certificate(s) to use.
...
* **certificateNameCheckValidationMode**: 'CustomCertificateSubject' | 'IncomingHostHeader' | 'OriginHostname' | string: The validation mode for certificate name check. Only applicable when enforceCertificateNameCheck is true.
* **customCertificateSubjects**: string[] {minLength: 1, maxLength: 2}: The list of custom certificate subjects to validate against. Only applicable when certificateNameCheckValidationMode is 'CustomCertificateSubject'. Must contain 1 or 2 entries.
* **deploymentStatus**: 'Failed' | 'InProgress' | 'NotStarted' | 'Succeeded' | string (ReadOnly)
...
* **ruleName**: string {minLength: 1, maxLength: 60, pattern: "^[a-zA-Z][a-zA-Z0-9]{0,59}$"} (Required): Name of the rule.
...
* **tokenDestinationHeader**: 'Authorization' | 'X-Azure-Authorization' | string: The HTTP request header where the origin authentication token will be placed when forwarding the request to the origin. If not specified, the service will use the `Authorization` header for backward compatibility.
...
* **value**: [ResourceUsage](#resourceusage)[] (Required): The ResourceUsage items on this page
...
## RuleSetProperties
### Properties
* **batchMode**: bool: Indicates whether rule set is in batch mode. When batch mode is enabled, rules will be processed in a batch along with the rule set.
...
* **provisioningState**: 'Creating' | 'Deleting' | 'Failed' | 'Succeeded' | 'Updating' | string (ReadOnly): Provisioning status
* **rules**: [BatchRuleProperties](#batchruleproperties)[]: A list of rules that are part of this rule set provided the rule set is in batch mode.
...
* **isProfileLevel**: bool: Indicates if this is a profile-level WAF policy.
...
* **routes**: [ResourceReference](#resourcereference)[]: List of routes.
...
### Properties
* **nextLink**: string: The link to the next page of items
* **value**: [Usage](#usage)[] (Required): The Usage items on this page
