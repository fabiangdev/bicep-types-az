# Microsoft.RedHatOpenShift @ 2026-09-01-preview

## Resource Microsoft.RedHatOpenShift/hcpOpenShiftClusters@2026-09-01-preview
...
## Resource Microsoft.RedHatOpenShift/hcpOpenShiftClusters/externalAuths@2026-09-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.RedHatOpenShift/hcpOpenShiftClusters/nodePools@2026-09-01-preview
* **Readable Scope(s)**: ResourceGroup
* **Writable Scope(s)**: ResourceGroup
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Resource Microsoft.RedHatOpenShift/locations/hcpOpenShiftVersions@2026-09-01-preview
...
## Resource Microsoft.RedHatOpenShift/locations/hcpOperatorIdentityRoleSets@2026-09-01-preview
* **Readable Scope(s)**: Subscription
* **Writable Scope(s)**: None
### Properties
* **apiVersion**: '2026-09-01-preview' (ReadOnly, DeployTimeConstant): The resource api version
...
## Function requestAdminCredential (Microsoft.RedHatOpenShift/hcpOpenShiftClusters@2026-09-01-preview)
* **Resource**: Microsoft.RedHatOpenShift/hcpOpenShiftClusters
* **ApiVersion**: 2026-09-01-preview
* **Input**: [HcpOpenShiftClusterAdminCredentialRequest](#hcpopenshiftclusteradmincredentialrequest)
...
* **message**: string {maxLength: 32768} (Required, ReadOnly): A human readable message indicating details about the transition.
This may be an empty string.
* **reason**: string {minLength: 1, maxLength: 1024, pattern: "^[A-Za-z]([A-Za-z0-9_,:]*[A-Za-z0-9_])?$"} (Required, ReadOnly): A programmatic identifier indicating the reason for the condition's last transition.
This value should be a CamelCase string.
* **status**: 'False' | 'True' | 'Unknown' | string (Required, ReadOnly): The status of the condition.
* **type**: 'Available' | 'Degraded' | 'Progressing' | string (Required, ReadOnly): Type of the condition.
...
* **keyManagementMode**: 'CustomerManaged' | string (Required): Specify the key management strategy used for the encryption key that encrypts the ETCD data.
...
* **status**: [ResourceStatus](#resourcestatus) (ReadOnly): Status of the external auth resource
...
### Properties
* **certificateSigningRequest**: string: PEM encoded certificate request
...
* **cryptoRestrictions**: 'FIPS' | 'None' | string: Cryptographic restrictions for kernel and userspace libraries
...
* **ingress**: [IngressProfile](#ingressprofile): The cluster ingress configuration
...
* **status**: [ResourceStatus](#resourcestatus) (ReadOnly): Status of the cluster resource
...
## IngressProfile
### Properties
* **type**: 'Disabled' | 'Private' | 'Public' | string: The type of the default cluster ingress.
...
- Maximum: 200 (only when availabilityZone is not specified)
- No maximum when availabilityZone is specified
* **status**: [ResourceStatus](#resourcestatus) (ReadOnly): Status of the node pool resource
...
* **sizeGiB**: int {minValue: 64, maxValue: 4095}: The OS disk size in GiB. Maximum is 4095 GiB for Managed disks. For Ephemeral disks,
...
## ResourceStatus
### Properties
* **conditions**: [Condition](#condition)[] {maxLength: 10} (ReadOnly): The conditions on the resource
